...
export default function Property() {
    ...
    return (
        <div className='flex flex-col gap-[80px] pt-[80px] lg:pb-14 md:pb-[64px] pr-[-80px]  mx-auto'>
            ...
            <div className='property_content lg:w-[1120px] lg:pl-0 pl-[30px] md:pl-[80px] md:w-[1024px] w-[375px]'>
...
function Item() {
    return (
        <div className="flexImportant flex-col gap-[21px] relative p-5  ">
...
function SampleNextArrow(props:props) {
    ...
    return (
        <div
            className={'z-500 w-10 h-10  rounded-full flexImportant items-center justify-center absolute lg:top-[-50%] lg:translate-y-[50%] lg:left-[1024px] md:top-[-50%] md:translate-y-[50%] md:left-[864px] translate-x-[50%] bottom-[-40px] left-[15px] border-0 hover:border-2 border-[#E6E8EC] transition-all duration-150 ease-in-out'}
            style={{ ...style }}
            onClick={onClick}
        >
...
function SamplePrevArrow(props:props) {
    ...
    return (
        <div
            className={'z-500 w-10 h-10  rounded-full flexImportant items-center justify-center absolute lg:top-[-50%] lg:left-[1024px] lg:translate-y-[50%] md:top-[-50%] md:left-[864px] md:translate-y-[50%] translate-x-[-50%] bottom-[-40px] left-[10px]  border-0 hover:border-2 border-[#E6E8EC] transition-all duration-150 ease-in-out'}
            style={{ ...style }}
            onClick={onClick}
        >
